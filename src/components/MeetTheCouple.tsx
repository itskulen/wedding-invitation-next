...
const couples: CoupleProfile[] = [
  ...
  },
  {
    ...
    introBody: 'Valen adalah sosok yang tenang, bertanggung jawab, dan memiliki semangat besar untuk membahagiakan keluarga.',
    secondaryBody: 'Ia gemar berkegiatan outdoor, menikmati proses, dan menghargai setiap perjalanan hidup dengan penuh syukur.',
    cardImage: '/vln2.jpg',
    profileSlides: ['/V.jpg', '/p6.jpeg', '/p9.jpeg', '/P16.png'],
